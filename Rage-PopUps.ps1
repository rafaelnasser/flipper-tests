...
$msgs = @(
"Gás R$50. FAZ O L!!?"
"Gasolina R$6. FAZ O L!!"
"Imposto de renda para +1.5 salários mínimos (VOCE). FAZ O L!!"
"Bolsa Presidiario R$1800 Salário Mínimo R$1300. FAZ O L!!"
"Produtos em falta no mercado? FAZ O L!!"
"Votou 13?? Paga a conta e FAZ O L!!"
"Usou seu bolsa picanha, troxa? FAZ O L!!"
"Mais Médicos = escravidão e voce votou nisso. FAZ O L!!"
"As eleições foram roubdas e voce aceitou de boa. Agora faz o L!!"
"Pronto para passar fome com inflação em +20%? FAZ O L!!"
)
